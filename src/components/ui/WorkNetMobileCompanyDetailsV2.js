...
const WorkNetMobileCompanyDetailsV2 = ({ jobDetails }) => {
    // const handlePress = () => {
    //     const { 홈페이지 } = companyDetails;
    //     if (홈페이지) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.card}>
                ...
                <DetailRow label="기업명" value={jobDetails.회사명 || '기업명 없음'} />
                <DetailRow label="대표자명" value={jobDetails.대표자명 || '대표자명 없음'} />
                <DetailRow label="업종" value={jobDetails.업종 || '업종 정보 없음'} />
                <DetailRow label="주요사업" value={jobDetails.주요사업 || '주요사업 정보 없음'} />
                <DetailRow label="근로자수" value={jobDetails.근로자수 || '근로자수 정보 없음'} />
                <DetailRow label="회사주소" value={jobDetails.회사주소 || '회사주소 정보 없음'} />
...
export default WorkNetMobileCompanyDetailsV2;
