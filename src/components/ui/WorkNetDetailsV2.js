    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.card}>
                ...
                <Text style={styles.title}>{jobDetails.채용제목}</Text>
                ...
                <DetailRow label="공통사항" value='' />
                <Text style={styles.detail}>{jobDetails.공통사항}</Text>
                <Text style={styles.date}>{jobDetails['D-Day']}</Text>
                {/* <Text style={styles.closingDate}>{jobDetails.접수기간}</Text> */}
