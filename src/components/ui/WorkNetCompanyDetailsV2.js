...
const WorkNetCompanyDetailsV2 = ({ jobDetails }) => {
    const handlePress = () => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.card}>
                ...
                <DetailRow label="기업명" value={jobDetails.회사이름} />
                <DetailRow label="주소" value={jobDetails.회사주소} />
...
export default WorkNetCompanyDetailsV2;
